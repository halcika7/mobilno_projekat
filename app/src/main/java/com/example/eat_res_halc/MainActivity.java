...
import com.example.eat_res_halc.Remote.CloudFunctions;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        cloudFunctions = RetrofitCloudClient.getInstance().create(CloudFunctions.class);
